...
cx_Freeze.setup(
    ...
    options = {"build_exe": {"packages":["tkinter","os"], "include_files":["face.ico",'tcl86t.dll','tk86t.dll', 'images','data_set','database','attendance_reports',]}},
    version = "1.0",
    description = "Face Recognition Automatic Attendace System | Developed By Waqas Ahmad",
